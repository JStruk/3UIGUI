...
class PanDiv extends JPanel implements ActionListener {
    ...
    int nAns, nScore = 0, nTotal = 0, n1, n2, nTime = 30, nMod;
    ...
    public PanDiv() {
        ...
        lblDiv.setFont(new Font("Serif", Font.PLAIN, 20));
        lblDiv.setForeground(Color.magenta);
        lblDiv.setBounds(150, 10, 1000, 20);
        add(lblDiv);
        txtIn.setBounds(210, 50, 100, 20);
        add(txtIn);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        lblFinal.setText("YOUR DIVISION TEST SCORE: " + nScore + " / " + nTotal);
